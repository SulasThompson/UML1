 ...
 fDetector(0)
{
  ...
  auto pParticleTable = G4ParticleTable::GetParticleTable();
  auto particle = pParticleTable->FindParticle("e-");
  fpGeneralParticleSource->SetParticleDefinition(particle);
  fpGeneralParticleSource->SetParticlePosition(G4ThreeVector(0., 0., 0.));
...
{    
  ...
  fpGeneralParticleSource->SetParticlePosition(G4ThreeVector(rx,ry,rz));
//  fpGeneralParticleSource->SetParticleMomentumDirection(G4RandomDirection());
